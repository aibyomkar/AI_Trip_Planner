...
with st.form(key='concierge_form', clear_on_submit=True):
    user_input = st.text_area('Share your travel aspirations...', height=100, placeholder="Plan a 5-day Goa trip for 5 people, prefer beaches & mountains, ₹30K/person budget, show next week's 5-day weather & per-day expense.")
